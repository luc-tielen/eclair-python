...
range_query.end:
  ...
  call ccc void @eclair_btree_insert_range_delta_reachable_reachable(ptr %18, ptr %stack.ptr_5, ptr %stack.ptr_6)
  br label %loop_1
loop_1:
...
end_if_4:
  ...
  call ccc void @eclair_btree_insert_range_reachable_new_reachable(ptr %61, ptr %stack.ptr_17, ptr %stack.ptr_18)
